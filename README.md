...
```js
{
  ...
  "optimizeImages.appOptions": [], // An array of options to be passed to the app on execution. Use the placeholder '[filepath]' (without quotes) to insert the filepath to the currently processed file
